...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->db->query("width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW(), date_modified = NOW()");


        $product_id = DB::table($this->config['db_prefix'].'product')->insertGetId([
            'model'                 =>  $data['model'],
            'sku'                   =>  isset($data['sku']) ? (int)$data['sku'] : null,
            'upc'                   =>  isset($data['upc']) ? (int)$data['upc'] : null,
            'ean'                   =>  isset($data['ean']) ? (int)$data['ean'] : null,
            'jan'                   =>  isset($data['jan']) ? (int)$data['jan'] : null,
            'isbn'                  =>  isset($data['isbn']) ? (int)$data['isbn'] : null,
            'mpn'                   =>  isset($data['mpn']) ? (int)$data['mpn'] : null,
